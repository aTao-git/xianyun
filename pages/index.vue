    ...
    <div class="block">
      ...
      <el-carousel trigger="click">
        <el-carousel-item v-for="(item,index) in banners" :key="index">
          <div class="bannerimg" :style="`background: url(${$axios.defaults.baseURL + item.url}) center center no-repeat;background-size:contain contain;`" />
        </el-carousel-item>
      </el-carousel>
    </div>
    <!-- 轮播图部分结束 -->
...
.container
  ...
  .banner-content
    ...
    top: 45%
    margin-left: -500px
    border-top: 1px transparent soli
    .search-bar
      width: 552px
      margin: 0 auto
    .search-tab
